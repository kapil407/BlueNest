...
export const generatePost = async (req, res) => {
  ...
  try {
    ...
    if (req.file) {
      ...
      const imageContent = fileToGenerativePart(
        req.file.path,
        req.file.mimetype,
      );
    ...
    const chat = ai.chats.create({
      ...
      config: {
        systemInstruction:
          "Create a catchy post based on the provided image or text. The entire post MUST be under 30 words maximum and 20 word minimum.",
      },
    });

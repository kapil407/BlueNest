...
import  {signUpController,LoginController,LogOutController,
    editProfileController,bookmarksController,getProfileController ,getOthersProfileController,FollowingController,unFollowController} from "../Controller/UserController.js";
...
FollowingRouter.patch('/follow/:id',isAuthentication,FollowingController);
unFollowRouter.patch('/unfollow/:id',isAuthentication,unFollowController);

export  {signUpRouter,loginRouter,logOutRouter,TweetRouter,DeleteRouter,likeOrDisLikeRouter,editProfileRouter,bookmarksRouter,getProfileRouter,getOthersProfileRouter,FollowingRouter,unFollowRouter};
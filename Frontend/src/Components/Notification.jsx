...
const NotificationComponent = () => {
  ...
  return (
    <div className="flex flex-col   fixed inset-0 z-50 flex  items-center justify-center bg-black/30 backdrop-blur-sm">
      <h1
        className="text-2xl py-2 bg-cover bg-center bg-clip-text text-transparent"
        style={{
      ...
      <div
        className={`flex h-full w-full flex-col  lg:w-[50%] lg:h-[70%]  text-white  lg:border-b border-slate-700   text-xl font-black 
                   `}
        style={{
          backgroundImage: `url(/notifi.jpg)`,

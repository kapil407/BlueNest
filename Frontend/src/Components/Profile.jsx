...
function Profile() {
  return (
    <>
      <div className="w-[50%]">
        <div>
          <Link to="/" className="flex py-4 items-center"> 
         
            <IoMdArrowRoundBack size={20} />  
           
            <div className="flex flex-col ml-2">
              <h1 className="font-bold text-lg ">Kapil</h1>
              <p className="text-gray-400">10 Post</p>
            </div>
          </Link>
        ...
        <Avatar src="https://tecdn.b-cdn.net/img/new/avatars/2.webp" size="102" round={true} />
         </div>
         <div className="text-right my-4">
        <button className="rounded-full  px-3 py-1 hover:bg-gray-200 border border-gray-400 cursor-pointer ">Edit Profile</button>
         </div>
         <div className="m-4">
